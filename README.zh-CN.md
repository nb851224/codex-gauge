...
当前版本：`0.2.5` · 本项目为社区开源工具，并非 OpenAI 官方产品。
...
从 [GitHub Releases](https://github.com/nb851224/codex-gauge/releases) 下载最新的 `Codex-Gauge-v0.2.5-macOS-arm64.zip`，解压后打开 `Codex Gauge.app`。
